...
date: 2025-5-29
venue: 'IEEE TRANSACTIONS ON MEDICAL IMAGING（TMI）, IF=8.9'
slidesurl: 'http://academicpages.github.io/files/slides1.pdf'
paperurl: 'http://academicpages.github.io/files/paper1.pdf'
bibtexurl: 'http://academicpages.github.io/files/bibtex1.bib'
citation: 'Huayi Wang, et al. (2025). &quot;Decouple, Reorganize, and Fuse: A Multimodal Framework for Cancer Survival Prediction.&quot; <i>IEEE TRANSACTIONS ON MEDICAL IMAGING（TMI）, IF=8.9</i>.'
---
